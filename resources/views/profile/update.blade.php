...
@section('content')
    <h1 class="text-success fw-bold display-5 ms-3 mb-4">Account Profile</h1>
            ...
            <div class="modal-content">
                <form action="{{ route('profile.update') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- Password (optional) --}}
                        <div class="mb-3">
                            <label for="password" class="form-label fw-semibold">New Password <small>(leave blank if unchanged)</small></label>
