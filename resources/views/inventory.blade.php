...
@section('content')
    <h1 class="text-[#A0C878] font-bold text-5xl ml-3 text-shadow-lg mb-10">Inventory</h1>
                ...
                @foreach ($inventories as $inventory)
                    <tr class="odd:bg-[#9EBC8A] even:bg-[#73946B] text-[#FAF6E9]">
                        ...
                        <td class="px-6 py-4 w-36">
                            <button type="button"
                                class="text-white bg-[#537D5D] hover:bg-[#73946B] font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none text-shadow-lg shadow-lg w-full">
                                ADD
                            </button>
                        </td>
                    </tr>
